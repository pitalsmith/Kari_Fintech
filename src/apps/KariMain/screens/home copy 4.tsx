  ...
  return (
    <Tab.Navigator
      screenOptions={({ route, navigation }) => ({
        header: () => <AppHeader navigation={navigation} />, // header with hamburger
...
export function MainDrawer() {
    ...
    return (
      <SafeAreaView style={styles.container}>
        <DrawerContentScrollView {...props} contentContainerStyle={styles.scrollContainer}>
          ...
          <View style={styles.profileSection}>
            <View style={styles.avatarGlow}>
              <Image 
                source={{ uri: 'https://via.placeholder.com/100' }} // Swap with your user image
        ...
        <View style={styles.footer}>
          <TouchableOpacity style={styles.logoutBtn} onPress={() => console.log('Logging out...')}>
  ...
  return (
    ...
    >
      {/* Assuming MainTabs is imported or defined elsewhere */}
      <Drawer.Screen name="Tabs" component={MainTabs} />
    </Drawer.Navigator>
  );
}
