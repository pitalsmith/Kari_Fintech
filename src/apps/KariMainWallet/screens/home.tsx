...
header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingVertical: 0, marginBottom: 0, 
  marginTop: -20, backgroundColor: COLORS.white, paddingBottom: 20 },
  ...
  avatarGlow: { width: 85, height: 85, borderRadius: 42.5, justifyContent: 'center', alignItems: 'center', marginBottom: 15, shadowColor: COLORS.primary, 
  shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.4, shadowRadius: 12, elevation: 15 },
  avatarGlowMain: { borderRadius: 42.5, justifyContent: 'center', alignItems: 'center', marginBottom: 0, shadowColor: '#FFCC00', 
  shadowOffset: { width: 0, height: 8 }, shadowOpacity: 0.8, shadowRadius: 12, elevation: 15 },
